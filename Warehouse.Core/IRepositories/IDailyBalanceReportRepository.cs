...
namespace Warehouse.DAL
{
    public interface IDailyBalanceReportRepository
    {
        ...
        Task<List<DailyBalanceDto>> GetByDateRangeAsync(DateTime startDate, DateTime endDate, int warehouseId, int blankId);
        Task<List<DailyBalanceDto>> GetByDateRangeAsync(DateTime startDate, DateTime endDate, int warehouseId);
    }
}